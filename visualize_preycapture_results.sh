...
#python $HOME/RGC2Prey/RGC2Prey/visual_preycapture_prediction.py --experiment_names '2025100602' --epoch_number 200 --test_ob_folder 'white-spot' --test_bg_folder 'blend' --boundary_size '(200, 120)' --noise_levels 0.0 0.016 0.032 0.064 0.128 0.256 --num_worker 24
